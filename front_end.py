...
def search_command():
    list_box.delete(0, END)
    e = back_end.search(title_text.get(), author_text.get(), year_text.get(), isbn_text.get())
...
update_selected = Button(window, text="Update Selected", width=12, command=update_command)
